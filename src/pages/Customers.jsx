			...
			<Table variant="unstyled" size="sm">
				<Thead>
					<Tr maxWidth="100%">
						...
						<Th fontSize="14px" textAlign="center" maxWidth="50px">email</Th>
						<Th fontSize="14px" textAlign="center" maxWidth="50px">Telefono</Th>
						<Th fontSize="14px" textAlign="center" maxWidth="50px">Descripcion</Th>
					</Tr>
				</Thead>
				<Tbody>
					{customers.map((customer) => (
						<Tr>
							<Td textAlign="center" isTruncated maxWidth="50px">{customer.name}</Td>
							<Td textAlign="center" isTruncated maxWidth="80px">{customer.email}</Td>
							<Td textAlign="center" isTruncated maxWidth="50px">{customer.phone}</Td>
							<Td textAlign="center" isTruncated maxWidth="50px">{customer.description}</Td>
