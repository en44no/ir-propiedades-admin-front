...
const UsersState = (props) => {
  ...
  const addUser = async (data) => {
    ...
    await axios
      .post(`http://test.ianrodriguezprop.com:4000/users`, data)
      .then((res) => {
  ...
  const editUser = async (data, userId) => {
    ...
    await axios
      .put(`http://test.ianrodriguezprop.com:4000/users/${userId}`, data)
      .then((res) => {
  ...
  const deleteUser = async (userId) => {
    await axios
      .delete(`http://test.ianrodriguezprop.com:4000/users/${userId}`)
      .then((res) => {
        if (res.status === 200 || res.status === 201) {
          Notification(
  ...
  const fetchRoles = async () => {
    await axios
      .get(`http://test.ianrodriguezprop.com:4000/roles`)
      .then((res) => {
        setRoles(res.data);
      })
      .catch((error) => {});
